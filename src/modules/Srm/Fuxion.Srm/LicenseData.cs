...
namespace Fuxion.Srm
{
    ...
    {
        public LicenseData() { }
        public LicenseData(LicenseContent content)
        {
            //var type = content.GetType();
            //Content = content;
            Content = new JRaw(content.ToJson(Formatting.None));
        }
        //LicenseContent _Content;
        //[JsonIgnore]
        //public LicenseContent Content { get { return _Content; } set { _Content = value; ContentType = value.GetType().FullName; } }
