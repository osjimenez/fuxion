...
namespace Fuxion.Windows.Controls
{
	...
	public class AutoGrid : Grid
	{
		...
		public static readonly DependencyProperty ColumnHorizontalContentAlignmentsProperty =
			DependencyProperty.Register(nameof(ColumnHorizontalContentAlignments), typeof(string), typeof(AutoGrid),
		...
		public static readonly DependencyProperty ColumnVerticalContentAlignmentsProperty =
			DependencyProperty.Register(nameof(ColumnVerticalContentAlignments), typeof(string), typeof(AutoGrid),
				new FrameworkPropertyMetadata(null,
					FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsArrange,
					new PropertyChangedCallback((d, e) =>
					{
		...
		public static readonly DependencyProperty ColumnContentMarginsProperty =
			DependencyProperty.Register(nameof(ColumnContentMargins), typeof(string), typeof(AutoGrid),
				new FrameworkPropertyMetadata(null,
					FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsArrange,
					new PropertyChangedCallback((d, e) =>
					{
		...
		public static readonly DependencyProperty ColumnsProperty =
			DependencyProperty.RegisterAttached(nameof(Columns), typeof(string), typeof(AutoGrid),
		...
		public static readonly DependencyProperty ColumnSharedSizeGroupsProperty =
			DependencyProperty.Register(nameof(ColumnSharedSizeGroups), typeof(string), typeof(AutoGrid),
				new FrameworkPropertyMetadata(null,
					FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsArrange,
					new PropertyChangedCallback((d, e) =>
					{
