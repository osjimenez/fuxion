...
{
    public class VerifiedTimeProviderTest
    {
        public VerifiedTimeProviderTest(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        string[] NtpServersAddresses { get; } = new[]
{
        ...
        {
            await new VerifiedTimeProvider()
                .Transform(p => {
                    //foreach(var add in NtpServersAddresses)
                    //    p.AddProvider(new InternetTimeProvider
                    //    {
                    //        ServerAddress = add,
                    //        ServerType = InternetTimeServerType.Ntp,
