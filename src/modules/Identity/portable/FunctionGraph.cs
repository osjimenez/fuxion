...
namespace Fuxion.Identity
{
    public class FunctionGraph
    {
        ...
        public FunctionGraph(bool loadDefaults = true)
        {
            gra = new Graph<IFunction>();
            if (loadDefaults)
            {
    ...
    {
        public static FunctionCollectionFluent ForFunction(this FunctionGraph me, IFunction function) { return new FunctionCollectionFluent(me, function); }
    }
    public sealed class FunctionCollectionFluent
    {
        internal FunctionCollectionFluent(FunctionGraph collection, IFunction function)
        {
            Collection = collection;
            Function = function;
        }
        internal FunctionGraph Collection { get; set; }
