    ...
    public class Test2 : BaseTest
    {
        ...
        public void GrantParentDeniedChildren()
        {
            ...
            var query = 
                ...
                " No";
            PrintTest(permissionExplanation + query);
        ...
        public void CanByInstance()
        {
            ...
            string permissionExplanation = "Tengo:\r\n" +
                   $" - Permiso EDIT en el estado 'California' y sus sublocalizaciones\r\n";

            var query = (
                $"¿Debería poder '{nameof(Edit)}' una instancia de pais?\r\n" +
                " No").AsDisposable();
            PrintTest(permissionExplanation + query.Value);
        ...
        public void CanByInstance2()
        {
            ...
            string permissionExplanation = "Tengo:\r\n" +
                $" - Permiso EDIT en la categoria 'Purchases' y sus subcategorias\r\n";
        ...
        public void CannotByInstance()
        {
            ...
            var query = (
                ...
                " No").AsDisposable();
            PrintTest(permissionExplanation + query.Value);
            Assert.True(ide.Can(Edit).Instance2(File.Document.Word.Word1));
        }
    }
}