...
class FuncTaskManagerEntry<TResult> : TaskManagerEntry
{
	...
	public FuncTaskManagerEntry(Func<object, TResult> func, object state, TaskScheduler? scheduler, TaskCreationOptions options, ConcurrencyProfile concurrencyProfile = default,
