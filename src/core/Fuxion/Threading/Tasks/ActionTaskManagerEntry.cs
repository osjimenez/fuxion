...
class ActionTaskManagerEntry : TaskManagerEntry
{
	...
	public ActionTaskManagerEntry(Action<object> action, object state, TaskScheduler? scheduler, TaskCreationOptions options, ConcurrencyProfile concurrencyProfile = default,
