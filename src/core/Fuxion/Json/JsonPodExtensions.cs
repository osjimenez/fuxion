...
{
	public static IPodBuilder<JsonPod<TDiscriminator, T>> ToJson<TDiscriminator, T>(this IPodBuilder<IPod<TDiscriminator, T, T>> me)
		where TDiscriminator : notnull
		where T : notnull =>
		new PodBuilder<TDiscriminator, T, JsonValue, JsonPod<TDiscriminator, T>>(new (me.Pod.Discriminator, me.Pod.Inside()));
	
	public static IPodBuilder<IPod<TDiscriminator, byte[], byte[]>> ToUtf8<TDiscriminator, T>(this IPodBuilder<JsonPod<TDiscriminator, T>> me)
		where TDiscriminator : notnull 
		where T : notnull =>
		new PodBuilder<TDiscriminator, byte[], byte[], IPod<TDiscriminator, byte[], byte[]>>(new BypassPod<TDiscriminator, byte[], byte[]>(me.Pod.Discriminator, Encoding.UTF8.GetBytes(me.Pod.ToJson())));
	...
	public static IPodBuilder<JsonPod<TDiscriminator, object>> FromJson<TDiscriminator>(this IPodBuilder<IPod<TDiscriminator, string, string>> me) 
		where TDiscriminator : notnull
	{
	...
	public static IPodBuilder<IPod<TDiscriminator, byte[], byte[]>> FromBytes<TDiscriminator, T>(this IPodBuilder<JsonPod<TDiscriminator, T>> me) where TDiscriminator : notnull =>
		new PodBuilder<TDiscriminator, byte[], byte[], IPod<TDiscriminator, byte[], byte[]>>(new BypassPod<TDiscriminator, byte[], byte[]>(me.Pod.Discriminator,
