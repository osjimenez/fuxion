...
#nullable enable
		...
		public List<TypeDiscriminator> Inclusions { get; internal set; } = new List<TypeDiscriminator>();
		public List<TypeDiscriminator> Exclusions { get; internal set; } = new List<TypeDiscriminator>();
		...
		public static TypeDiscriminator Empty => new TypeDiscriminator(TypeDiscriminatorId, TypeDiscriminatorId);
