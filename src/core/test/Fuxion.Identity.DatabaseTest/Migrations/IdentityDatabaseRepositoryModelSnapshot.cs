...
class IdentityDatabaseRepositoryModelSnapshot : ModelSnapshot
{
	protected override void BuildModel(ModelBuilder modelBuilder)
	{
		modelBuilder.HasAnnotation("ProductVersion", "7.0.0-beta8-15964").HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
		...
		modelBuilder.Entity("Fuxion.Identity.Test.Entity.Permission", b =>
		{
			b.HasOne("Fuxion.Identity.Test.Entity.Identity").WithMany().HasForeignKey("IdentityId");
			b.HasOne("Fuxion.Identity.Test.Entity.Rol").WithMany().HasForeignKey("RolId");
		});
		modelBuilder.Entity("Fuxion.Identity.Test.Entity.RolGroup", b =>
		{
			b.HasOne("Fuxion.Identity.Test.Entity.Identity").WithMany().HasForeignKey("IdentityId");
			b.HasOne("Fuxion.Identity.Test.Entity.Group").WithMany().HasForeignKey("RolId");
		});
		modelBuilder.Entity("Fuxion.Identity.Test.Entity.Scope", b =>
		{
			b.HasOne("Fuxion.Identity.Test.Entity.Discriminator").WithMany().HasForeignKey("DiscriminatorId");
			b.HasOne("Fuxion.Identity.Test.Entity.Permission").WithMany().HasForeignKey("PermissionId");
		});
	}
}