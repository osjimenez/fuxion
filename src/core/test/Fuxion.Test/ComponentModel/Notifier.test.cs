...
#nullable enable
		...
		public override bool Equals(object? obj)
			=> obj is ReferenceObjectMock rom
				...
				: false;
		public override int GetHashCode() => Entero.GetHashCode() + Cadena.GetHashCode();
		public static bool operator ==(ReferenceObjectMock a, ReferenceObjectMock b) => EqualityComparer<ReferenceObjectMock>.Default.Equals(a, b);
		public static bool operator !=(ReferenceObjectMock a, ReferenceObjectMock b) => !EqualityComparer<ReferenceObjectMock>.Default.Equals(a, b);
		public static ReferenceObjectMock DefaultValue => new ReferenceObjectMock { Cadena = "aaa", Entero = 111 };
	}
...
#nullable enable
		...
		{
			get => GetLockedField(ref _Integer_FieldImplemented_WithoutDefault_RaiseAlways_Locked);
		...
		{
			get => GetField(ref _Integer_FieldImplemented_WithoutDefault_RaiseAlways_NotLocked);
		...
		{
			get => GetLockedField(ref _Integer_FieldImplemented_WithoutDefault_RaiseOnChange_Locked);
		...
		{
			get => GetField(ref _Integer_FieldImplemented_WithoutDefault_RaiseOnChange_NotLocked);
		...
		{
			get => GetLockedField(ref _Integer_FieldImplemented_WithDefault_RaiseAlways_Locked);
		...
		{
			get => GetField(ref _Integer_FieldImplemented_WithDefault_RaiseAlways_NotLocked);
		...
		{
			get => GetLockedField(ref _Integer_FieldImplemented_WithDefault_RaiseOnChange_Locked);
		...
		{
			get => GetField(ref _Integer_FieldImplemented_WithDefault_RaiseOnChange_NotLocked);
		...
		{
			get => GetLockedField(ref _String_FieldImplemented_WithoutDefault_RaiseAlways_Locked);
		...
		{
			get => GetField(ref _String_FieldImplemented_WithoutDefault_RaiseAlways_NotLocked);
		...
		{
			get => GetLockedField(ref _String_FieldImplemented_WithoutDefault_RaiseOnChange_Locked);
		...
		{
			get => GetField(ref _String_FieldImplemented_WithoutDefault_RaiseOnChange_NotLocked);
		...
		{
			get => GetLockedField(ref _String_FieldImplemented_WithDefault_RaiseAlways_Locked);
		...
		{
			get => GetField(ref _String_FieldImplemented_WithDefault_RaiseAlways_NotLocked);
		...
		{
			get => GetLockedField(ref _String_FieldImplemented_WithDefault_RaiseOnChange_Locked);
		...
		{
			get => GetField(ref _String_FieldImplemented_WithDefault_RaiseOnChange_NotLocked);
		...
		{
			get => GetValue<ReferenceObjectMock>();
			set => SetValue(value, false);
		}
		...
		{
			get => GetValue(() => ReferenceObjectMock.DefaultValue);
			set => SetValue(value, false);
		}
		...
		{
			get => GetField(ref _ReferenceObject_FieldImplemented_WithoutDefault_RaiseAlways_NotLocked);
		...
		{
			get => GetField(ref _ReferenceObject_FieldImplemented_WithoutDefault_RaiseOnChange_NotLocked);
		...
		{
			get => GetField(ref _ReferenceObject_FieldImplemented_WithDefault_RaiseAlways_NotLocked);
		...
		{
			get => GetField(ref _ReferenceObject_FieldImplemented_WithDefault_RaiseOnChange_NotLocked);
	...
	public class Notifier_Test
	{
		...
		public Notifier_Test() => TestInitialize();
		//[TestInitialize]
		...
		public void Notifier_VirtualProperty()
		{
			var mock = new DerivedNotifierMock
			{
				...
				Integer_Virtual_AutoImplemented_WithoutDefault_RaiseOnChange_NotLocked = 123
			};
