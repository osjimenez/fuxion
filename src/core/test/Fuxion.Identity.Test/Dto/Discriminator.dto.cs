...
namespace Fuxion.Identity.Test.Dto
{
	...
	{
		public StateDto(string id, string name, CountryDto country) : base(id, name)
		{
			Country = country;
		}
	...
	public class CountryDto : LocationDto
	{
		...
		protected override IEnumerable<LocationDto> GetLocationExclusions() => new LocationDto[] { };
	...
	{
		public CityDto(string id, string name, StateDto state) : base(id, name)
		{
			State = state;
		}
		...
		protected override IEnumerable<LocationDto> GetLocationExclusions() => new[] { State };

		protected override IEnumerable<LocationDto> GetLocationInclusions() => new LocationDto[] { };
	}
	[Discriminator("CAT")]
	public class CategoryDto : DiscriminatorDto
	{
		...
		protected override IEnumerable<DiscriminatorDto> GetExclusions() => new[] { Parent }.RemoveNulls();
	}
