	...
	public class PermissionTest : BaseTest
	{
		...
		public void WhenPermission_MatchByDiscriminatorsPath()
		{
			...
			Assert.False(
				...
				}.MatchByDiscriminatorsInclusionsAndExclusions(false, TypeDiscriminator.Empty, new IDiscriminator[] {
					States.California
			...
			Assert.False(
				...
				}.MatchByDiscriminatorsInclusionsAndExclusions(false, TypeDiscriminator.Empty, new[] {
					Countries.Usa
		...
		public void WhenPermission_Match()
		{
			...
			Assert.True(
				...
				}.Match(false, Read, TypeDiscriminator.Empty,
					new[] {
						Cities.SanFrancisco
					}),
				$"Si tengo permiso para {nameof(Edit)} en {nameof(States.California)} y se propaga {propagation}." +
