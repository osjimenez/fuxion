...
public class UriKeyResetException(string message) : UriKeyException(message);
public class UriKeyInheritanceException(string message) : UriKeyException(message);
