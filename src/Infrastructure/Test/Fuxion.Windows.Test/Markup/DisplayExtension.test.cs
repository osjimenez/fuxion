...
public class DisplayExtensionTest : BaseTest
{
	...
	public async Task DifferentValues() => await StartSTATask(() =>
										   {
	...
	public async Task DirectProperty() => await StartSTATask(() =>
										  {
	...
	public async Task DirectPropertyFrameworkContentElement() => await StartSTATask(() =>
																 {
	...
	public async Task TwoLevelProperty() => await StartSTATask(() =>
											{
	...
	public async Task ThreeLevelProperty() => await StartSTATask(() =>
											  {
	...
	public async Task ThreeLevelPropertyWithoutDisplay() => await StartSTATask(() =>
															{
...
{
	public ServiceProviderMock(object targetObject, object targetProperty) => provideValueTargetMock = new ProvideValueTargetMock(targetObject, targetProperty);

	private readonly ProvideValueTargetMock provideValueTargetMock;
...
public class Dto2Mock : INotifyPropertyChanged
{
	...
	private Dto3Mock? _Dto3WithoutDisplayAttribute;
