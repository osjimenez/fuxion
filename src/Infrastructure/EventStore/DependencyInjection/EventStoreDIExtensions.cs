...
{
	public static IFuxionBuilder EventStore(this IFuxionBuilder me, out Func<IServiceProvider, EventStoreStorage> builder, string hostName = "localhost", int port = 2113, string username = "admin",
