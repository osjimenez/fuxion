...
namespace Microsoft.Extensions.DependencyInjection
{
	...
	{
		public static ISingularityBuilder EventStore(this ISingularityBuilder me, out Func<IServiceProvider, EventStoreManager> builder, string hostName = "localhost", int port = 1113, string username = "admin", string password = "changeit")
		{
