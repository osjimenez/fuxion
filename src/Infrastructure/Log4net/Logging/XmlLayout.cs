...
namespace Fuxion.Logging
{
	...
	public class XmlLayout : XmlLayoutBase
	{
		...
		{
			writer.WriteStartElementSpliting(m_elmEvent);
			...
			writer.WriteStartElementSpliting(m_elmMessage);
			...
			{
				writer.WriteStartElementSpliting(m_elmProperties);
				foreach (System.Collections.DictionaryEntry entry in properties)
				{
					writer.WriteStartElementSpliting(m_elmData);
			...
			if (exceptionStr != null && exceptionStr.Length > 0)
			{
				...
				writer.WriteStartElementSpliting(m_elmException);
			...
			if (LocationInfo)
			{
				...
				writer.WriteStartElementSpliting(m_elmLocation);
	...
	{
		public static void WriteStartElementSpliting(this XmlWriter me, string localName)
		{
#if NETSTANDARD2_0
			var split = localName.Split(':');
			if (split.Length > 1)
			{
				me.WriteStartElement(split[0], split[1], split[0]);
			}
			else
				me.WriteStartElement(localName);
#else
			me.WriteStartElement(localName);
#endif
		}
